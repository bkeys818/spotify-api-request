 ...
 * @param {string} options.market - An [ISO 3166-1 alpha-2 country code](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) orstring `from_token`. Provide this parameter if you want to apply [Track Relinking](https://developer.spotify.com/documentation/general/guides/track-relinking-guide/).
 ...
 * @param {Object} [options]
 * @param {string} options.market - The market you’d like to request. Synonym for `country`.
 ...
 * @param {Object} [options]
 * @param {string} [options.market] - The market you’d like to request. Synonym for `country`.
 * @param {number} [options.limit=20] - The maximum number of tracks to return. Default: 20. Minimum: 1. Maximum: 50.
 * @param {number} [options.offset=0] - The index of the first track to return. Default: 0 (the first object). Use with limit to get the next set of tracks.
...
export default {
    getMultipleAlbums: getMultipleAlbums,
    getAlbum: getAlbum,
