...
import type { PagingObject, ArtistObject, TrackObject } from './objects'
 ...
 */
export async function getUsersTopArtistsandTracks(
    token: Token | string,
    type: 'artists' | 'tracks',
    options?: {
        /** 
...
): Promise<PagingObject<ArtistObject | TrackObject>> {
    return await (
        await sendRequest({
