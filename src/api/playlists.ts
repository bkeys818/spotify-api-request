 ...
 * @param {number} [options.limit=20] - The maximum number of playlists to return. Default: 20. Minimum: 1. Maximum: 50.
 * @param {number} [options.offset=0] - The index of the first playlist to return. Default: 0 (the first object). Maximum offset: 100,000. Use with `limit` to get the next set of playlists.
...
/**
 * Create a playlist for a Spotify user. (The playlist will be empty until you {@link addTracks add tracks}.)
 ...
 * @param {string} playlistId - The [Spotify ID](https://developer.spotify.com/documentation/web-api/#spotify-uris-and-ids) for the playlist.
 * @param {Object} options
 * @param {string} options.name - The new name for the playlist, for example `"My New Playlist Title"`.
 * @param {boolean} [options.public] - If `true` the playlist will be public, if `false` it will be private.
 * @param {boolean} [options.collaborative] - If `true` , the playlist will become collaborative and other users will be able to modify the playlist in their Spotify client. Note: You can only set `collaborative` to `true` on non-public playlists.
 * @param {string} [options.description] - Value for playlist description as displayed in Spotify Clients and in the Web API.
 * @return {Promise<void>}
 */
